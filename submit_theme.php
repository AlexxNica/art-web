...
else
{
	...
	print("<tr><td><b>Category</b></td><td><select name=\"category\"><option value=\"\">Choose<option value=\"gdm_greeter\">GDM Greeter<option value=\"gtk\">GTK+ 1.2<option value=\"gtk2\">GTK+ 2.0<option value=\"icon\">Icon<option value=\"metacity\">Metacity<option value=\"metatheme\">Metatheme<option value=\"nautilus\">Nautilus<option value=\"sawfish\">Sawfish<option value=\"sounds\">Sounds<option value=\"splash_screens\">Splash Screens<option value=\"other\">Other</select></td></tr>\n");
