...
print("<html>\n<head><title>Add a Background</title></head>\n<body>\n");
print("<div align=\"center\">");
print("<font size=\"+2\">Add a Background</font>\n<p>\n");
if($HTTP_POST_VARS)
{
...
else
{
   ...
   print("<tr><td><b>Background Description:</b></td><td><textarea name=\"background_description\" cols=\"40\" rows=\"5\" wrap></textarea></td></tr>\n");
   ...
   print("<input type=\"submit\" value=\"Add Background\">");
   print("</form>\n");
}
print("</div>\n</body>\n</html>\n");
?>
